...
docker run --gpus all  -v datavol:/app/data -v outputsByAIvol:/app/outputsByAI -v outputsByBtvol:/app/outputsByBt -v outputsFromTrainingvol:/app/outputsFromTraining -ti testdeploy:dev
