...
def runBt(datapath:str, ticker:str, mode:str, end_date:str):
    ...
    cerebro.addanalyzer(bt.analyzers.AnnualReturn, _name='AnnualReturn') # 年化收益率
    ...
    img[0][0].savefig(os.path.join(output_path, f'{ticker}_{mode}_{end_date}.png')) if mode != '' else img[0][0].savefig(os.path.join(output_path, f'{ticker}_{end_date}.png'))
    # 从返回的 result 中提取回测结果
    strat = result[0]
