...
results, heatmap = bt.optimize(rsi_period = range(9,10), rsi_1 = range(17,30), rsi_2 = range(70,80), maximize='Sharpe Ratio', return_heatmap=True)
...
print("Bt: ", bt._strategy.rsi_period)
members = [attr for attr in dir(bt._strategy) if not callable(getattr(bt._strategy, attr)) and \
