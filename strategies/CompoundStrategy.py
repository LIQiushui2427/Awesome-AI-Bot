...
class CompoundStrategy(SmaCross, FollowLargeTraderStrategy):
    ...
    def compose(self,strategies, weights):
        ...
        print("Composing Strategies... your strategies: ", strategies, " your weights: ", weights)
        
        self.strategies = strategies
        self.weights = weights
        
        assert len(strategies) == len(weights), "The number of strategies and weights must be the same"
